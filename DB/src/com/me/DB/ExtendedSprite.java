...
public class ExtendedSprite extends Sprite {
	...
	public ExtendedSprite(Pixmap m)
	{
		super(new Texture(m));
	}
	...
	{
		this.setSize(getWidth() * DB.context.screen_size.x / 1366,
				getHeight() * DB.context.screen_size.y / 768);
	}
	...
	public void drawT(Pixmap p, int x, int y)
	{		
		getTexture().draw(p, x, y);
	}
